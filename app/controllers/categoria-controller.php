...
function registrarCategoria() {
    ...
    if ($objCategoria->registrar($data)) {
        mostrarSweetAlert('success', 'Éxito', 'Categoría creada correctamente', BASE_URL . '/admin/consultar-categorias');
    } else {
...
function actualizarCategoria() {
    ...
    if ($objCategoria->actualizar($data)) {
        mostrarSweetAlert('success', 'Actualizado', 'Categoría editada correctamente', BASE_URL . '/admin/consultar-categorias');
    } else {
...
function eliminarCategoria($id) {
    ...
    if ($objCategoria->eliminar($id)) {
        ...
        mostrarSweetAlert('success', 'Eliminado', 'Categoría eliminada', BASE_URL . '/admin/consultar-categorias');
    } else {

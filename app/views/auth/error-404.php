...
<head>
  ...
  <link rel="stylesheet" href="<?= BASE_URL ?>/public/assets/auth/css/error-404.css">
...
<body>
  <div class="error-container">
    <div class="space-scene">
      ...
      <img src="<?= BASE_URL ?>/public/assets/auth/img/astronauta.png" alt="Astronauta flotando en el espacio - Error 404"
  ...
  <script src="<?= BASE_URL ?>/public/assets/auth/js/error-404.js"></script>
</body>

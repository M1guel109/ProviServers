...
<body>
        ...
        <section id="titulo-principal">
            <div class="row align-items-start">
                <div class="col-md-8 d-flex flex-column">
                    ...
                    <a href="<?= BASE_URL ?>/admin/reporte?tipo=usuarios" target="_blank"
                        class="btn btn-primary mt-3 w-auto" style="width: fit-content;">
            ...
            <ul class="nav nav-tabs mb-3" id="tablaTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="tabla-tab" data-bs-toggle="tab"
                        data-bs-target="#tabla-pane" type="button" role="tab">
                        <i class="bi bi-table"></i> Listado Principal
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="acciones-tab" data-bs-toggle="tab"
                        data-bs-target="#acciones-pane" type="button" role="tab">
                            ...
                            <tbody>
                                <?php if (!empty($datos)) : ?>
                                    <?php foreach ($datos as $usuario) : ?>
                                        <?php
                                        // Determinar clase del badge según estado real de BD
                                        $estadoNombre = strtolower($usuario['estado'] ?? '');
                                        $clase = match ($estadoNombre) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($usuario['ubicacion'] ?? 'N/A') ?></td>
                                            <td><?= ucfirst(htmlspecialchars($usuario['rol'])) ?></td>
                                            <td>
                                                <span class="status-badge <?= $clase ?>">
                                                    <?= htmlspecialchars($usuario['estado'] ?? 'pendiente') ?>
                                                </span>
                                            </td>
                                            <td>
                                                <div class="action-buttons">
                                                    <button type="button" class="btn-action btn-view"
                                                        ...
                                                        onclick="cargarDetalleUsuario(<?= (int)$usuario['id'] ?>)">
                                                        <i class="bi bi-eye"></i>
                                                    </button>
                                                    ...
                                                    <button type="button" class="btn-action btn-delete"
                                                        title="Eliminar"
                                                        onclick="confirmarEliminacion('<?= BASE_URL ?>/admin/eliminar-usuario?accion=eliminar&id=<?= (int)$usuario['id'] ?>')">
                    ...
                    <div id="contenido-detalle" class="d-none">
                        ...
                        <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                            <div class="position-relative">
                                ...
                                <span id="modal-estado-badge"
                                    class="position-absolute bottom-0 start-100 translate-middle p-2 border border-light rounded-circle bg-success"></span>
                            </div>
                            <div class="ms-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded h-100">
                                    <h6 class="text-primary fw-bold mb-3">
                                        <i class="bi bi-envelope-at me-2"></i>Contacto
                                    </h6>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded h-100">
                                    <h6 class="text-primary fw-bold mb-3">
                                        <i class="bi bi-shield-lock me-2"></i>Cuenta
                                    </h6>
                        ...
                        <div id="seccion-proveedor" class="mt-4 d-none">
                            <h6 class="border-bottom pb-2 mb-3 fw-bold text-dark">
                                Información Profesional
                            </h6>

                            <div class="mb-3">
                                <p class="fw-bold mb-2 small text-uppercase text-muted">
                        ...
                        <!-- SECCIÓN CLIENTE -->
                        <div id="seccion-cliente" class="mt-4 d-none">
                            <h6 class="border-bottom pb-2 mb-3 fw-bold text-dark">Actividad del Cliente</h6>
                            <div class="row g-3">
                                <div class="col-12">
                                    <p class="fw-bold mb-2 small text-uppercase text-muted">Servicios Contratados:</p>
                                    <div class="table-responsive border rounded">
                                        <table class="table table-sm table-hover mb-0">
                                            ...
                                            <tbody id="modal-historial-servicios"></tbody>
                                        </table>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <p class="fw-bold mb-2 small text-uppercase text-muted">Solicitudes / Necesidades:</p>
                                    <div id="modal-solicitudes-cliente" class="list-group list-group-flush border rounded"></div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="<?= BASE_URL ?>/public/assets/dashboard/js/detalle-usuario.js"></script>

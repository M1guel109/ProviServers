...
<head>
    ...
    <!-- ✅ CORREGIDO: faltaba Bootstrap Icons -->
...
<body>
    ...
    <main class="contenido">
        ...
        <section id="formulario-usuarios">
            <div class="contenedor-formulario">
                <form action="<?= BASE_URL ?>/admin/guardar-usuario"
                      method="POST"
                    ...
                    <div class="seccion-foto mb-4">
                        <div class="tarjeta-foto">
                            <div class="foto-perfil">
                                <img src="<?= BASE_URL ?>/public/uploads/usuarios/default_user.png"
                                     alt="Foto de perfil"
                                     id="foto-preview">
                            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <h6 class="text-primary border-bottom pb-2">1. Información Personal</h6>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12 mt-4">
                            <h6 class="text-primary border-bottom pb-2">2. Datos de Contacto</h6>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <label for="ubicacion" class="form-label">
                                Ubicación / Dirección <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control" id="ubicacion" name="ubicacion"
                                   placeholder="Ej: Fusagasugá, Barrio Centro" required>
                        </div>

                        <!-- SECCIÓN 3: SEGURIDAD -->
                        <div class="col-12 mt-4">
                            <h6 class="text-primary border-bottom pb-2">3. Seguridad de la Cuenta</h6>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-text">
                                Si se deja vacío, el sistema usará el No. de Documento como clave.
                            </div>
                        </div>

                        <!-- SECCIÓN 4: ROL -->
                        <div class="col-12 mt-4">
                            <h6 class="text-primary border-bottom pb-2">4. Rol en la Plataforma</h6>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div id="campos-proveedor" class="d-none animate-fade-in w-100">
                            ...
                            <div class="card bg-light border-0 mt-3 mb-3">
                                <div class="card-body">
                                    <h6 class="card-title text-dark">
                                        <i class="bi bi-tags"></i> Habilidades y Categorías
                                    </h6>
                                    <p class="small text-muted">
                                        Añade las áreas donde este proveedor tiene experiencia (máximo 5).
                                    </p>
                                    <div class="row g-2 align-items-end">
                                        <div class="col-md-5">
                                            <select class="form-select" id="select-categoria">
                                                ...
                                                <?php endforeach; ?>
                                                <option value="nueva" class="fw-bold text-primary">
                            ...
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    <h6 class="card-title text-dark">
                                        <i class="bi bi-file-earmark-text"></i> Documentación Requerida
                                    </h6>
                                    <div class="row g-3 mt-1">
                                        <div class="col-md-6">
                                            <label class="form-label d-flex justify-content-between">
                                                ...
                                                <i class="bi bi-info-circle text-primary"
                                                   ...
                                                   title="Copia legible por ambas caras."></i>
                                            </label>
                                            <input type="file" class="form-control"
                                                   name="doc-cedula" accept="image/*,.pdf">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label d-flex justify-content-between">
                                                ...
                                                <i class="bi bi-info-circle text-primary"
                                                   data-bs-toggle="tooltip"
                                                   title="Certificado de antecedentes judiciales vigente."></i>
                                            </label>
                                            <input type="file" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label d-flex justify-content-between">
                                                ...
                                                <i class="bi bi-info-circle text-primary"
                                                   data-bs-toggle="tooltip"
                                                   title="Foto sosteniendo el documento cerca del rostro."></i>
                                            </label>
                                            <input type="file" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label d-flex justify-content-between">
                                                ...
                                                <i class="bi bi-info-circle text-primary"
                                                   data-bs-toggle="tooltip"
                                                   title="Diplomas o cursos que validen su habilidad."></i>
                                            </label>
                                            <input type="file" class="form-control"
                                                   name="doc-certificado" accept="image/*,.pdf">
                                        </div>
                                    </div>
                                </div>
                            </div>

                        </div><!-- fin #campos-proveedor -->
    ...
    <script src="<?= BASE_URL ?>/public/assets/dashboard/js/registro-usuario.js"></script>
</body>
</html>
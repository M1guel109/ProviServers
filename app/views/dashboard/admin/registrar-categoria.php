...
<body>
    ...
    <main class="contenido">
        ...
        <section id="titulo-principal">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="text-muted mb-0">Registra nuevas categorías de servicios para la plataforma.</p>
                </div>
                <div class="col-md-4">
        ...
        <section id="formulario-categorias">
            <div class="contenedor-formulario">
                <form action="<?= BASE_URL ?>/admin/guardar-categoria"
                      method="POST"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="seccion-foto">
                            <div class="tarjeta-foto">
                                <div class="foto-perfil">
                                    <img src="<?= BASE_URL ?>/public/uploads/categorias/default_icon.png"
                                         alt="Ícono de Categoría"
                                         id="foto-preview">
                                </div>
                                <label for="icono-input" class="btn-agregar-foto">
                                    <i class="bi bi-image"></i> Subir Ícono
                                </label>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion"
                                      rows="4"
                                      placeholder="Describe qué tipo de servicios abarca esta categoría..."
                                      required></textarea>
                        </div>
    ...
    <!-- ✅ SweetAlert primero — categoria.js lo usa -->

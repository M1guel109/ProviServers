...
// 2. Obtener datos completos (Usando tu nueva función del modelo)
...
// Simulamos catálogo general (esto podría venir de BD)
$categorias_bd = [
...
// Si es proveedor, convertimos sus categorías (array) a string "Cat1,Cat2" para el JS
                                    ...
                                    <div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group btn-group-sm">
                                                                        <button type="button" class="btn btn-outline-success" onclick="cambiarEstadoDoc(<?= $doc['id'] ?>, 'aprobado')" title="Aprobar">
                                                                            <i class="bi bi-check-lg"></i>
                                                                        </button>
                                                                        <button type="button" class="btn btn-outline-danger" onclick="cambiarEstadoDoc(<?= $doc['id'] ?>, 'rechazado')" title="Rechazar">
                                        ...
                                        <?php else: ?>
                                            <div class="alert alert-warning py-2 small">
                                                <i class="bi bi-exclamation-circle"></i> Sin documentos cargados.
                                            </div>
                                        <?php endif; ?>
                                    </div>

...
try {
    ...
    $st = $pdo->prepare("
        SELECT sc.id AS contrato_id,
               ...
               COALESCE(cot.precio, pub_sol.precio, 0) AS monto,
               sc.estado
        FROM servicios_contratados sc
        INNER JOIN proveedores p ON p.id = sc.proveedor_id
    ...
    <main class="contenido">
        ...
        <section id="titulo-principal" class="section-hero mb-4">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="mb-1">Finanzas</h1>
                    <p class="text-muted mb-0">Controla tus ingresos, gastos y visualiza el estado financiero de tu negocio.</p>
                </div>
                <div class="col-md-4">

...
// Filtros
$q   = trim($_GET['q'] ?? '');
$urg = trim($_GET['urg'] ?? ''); // alta|media|baja
$fh  = trim($_GET['fh'] ?? '');  // hoy|semana|mes
...
<body>
      ...
      <div class="modal-content border-0 shadow">
        <div class="modal-header">
          <h5 class="modal-title">
            <i class="bi bi-eye me-2"></i> Detalle de la solicitud
          </h5>
        ...
        <div class="modal-body p-4">
          ...
          <div class="bg-light p-3 rounded-3 mb-4">
            ...
            <p class="mb-0 text-muted">
              ...
              Cliente: <span id="seg-cliente-nombre"></span>
            </p>
          </div>
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active fw-bold"
                data-bs-toggle="tab"
                data-bs-target="#tab-historial-modal"
                type="button"
                role="tab">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link fw-bold text-success"
                data-bs-toggle="tab"
                data-bs-target="#tab-nuevo-avance-modal"
                type="button"
                role="tab">
          ...
          <div class="tab-content mt-3">
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-content bg-light p-3 rounded-3">
                    ...
                    <p class="text-secondary small mb-0">
                      El proveedor aceptó la solicitud y el servicio comenzó.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="tab-nuevo-avance-modal" role="tabpanel">
              <form id="formSeguimientoModal" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control"
                    name="descripcion"
                    rows="4"
                    placeholder="Explica qué se hizo hoy..."
                    required></textarea>
                </div>

                <div class="mb-3">
                  <label class="form-label small fw-bold">
                    Archivo Adjunto <span class="text-muted fw-normal">(Opcional)</span>
                  </label>
  ...
  <script>
    ...
    function verDetalle(data) {
      ...
      if (!body || !modalEl) {
        console.error('No se encontró el modal de detalle o su body.');
        return;
      }

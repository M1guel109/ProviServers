...
// Si no existe, se usa un placeholder.
    ...
    <main class="contenido">
        ...
        <section id="solicitar-servicio" class="mt-2">
            ...
            <div class="row">
                        ...
                        <form action="<?= BASE_URL ?>/cliente/guardar-solicitud" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea
                                    ...
                                    class="form-control"
                                    rows="4"
                                    placeholder="Ej: Tengo una fuga de agua en el baño principal..."
                                    required></textarea>
                                <small class="text-muted">
                            ...
                            <div class="mb-3">
                                <label class="form-label">
                                    Dirección donde se prestará el servicio <span class="text-danger">*</span>
                                </label>
                                <input
                                    type="text"
                                    name="direccion"
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label">
                                        Fecha tentativa del servicio <span class="text-danger">*</span>
                                    </label>
                                    <input
                                        type="date"
                ...
                <!-- Columna derecha: resumen REAL de la publicación -->
                <div class="col-lg-4">
                    <div class="card p-3 mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted" style="font-size: 0.85rem;">
                                    Servicio: <?= htmlspecialchars($nombreServicio ?: '—') ?>
                                </p>
                                <?php if ($precioTexto): ?>
                                    <p class="mb-0 text-muted" style="font-size: 0.85rem;">
                        ...
                        <p class="text-muted mb-2" style="font-size: 0.85rem;">
                            <?= htmlspecialchars(mb_strimwidth($descripcionPub, 0, 180, '...')) ?>
                        </p>

                        <p class="text-muted mb-0" style="font-size: 0.85rem;">
                            Recuerda: esta solicitud no implica pago inmediato. El proveedor podrá contactarte por la
                            mensajería interna para confirmar detalles y acordar el precio final.
                        </p>
                    </div>
                </div>
            </div>

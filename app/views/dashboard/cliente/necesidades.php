    ...
    <section class="p-3">
      <div id="titulo-principal" class="section-hero mb-4">
        <div class="row align-items-center">
          <div class="col-md-8">
            <h1 class="mb-1">Mis Necesidades</h1>
            <p class="text-muted mb-0">Revisa tus necesidades publicadas y las ofertas recibidas.</p>
          </div>
          <div class="col-md-4">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 justify-content-md-end">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mis Necesidades</li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <?php foreach ($misNecesidades as $n): ?>
                  <a class="list-group-item list-group-item-action"
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="text-end">
                        <span class="badge bg-<?=
                                              ($n['estado'] === 'abierta' ? 'primary' : ($n['estado'] === 'cerrada' ? 'success' : 'secondary'))
                                              ?>">
                ...
                <?php foreach ($cotizaciones as $c): ?>
                  <div class="border rounded p-2 mb-2">
                    <div class="d-flex justify-content-between">
                      ...
                      <span class="badge bg-<?=
                                            ($c['estado'] === 'aceptada' ? 'success' : ($c['estado'] === 'rechazada' ? 'secondary' : 'primary'))
                                            ?>">

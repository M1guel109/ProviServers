...
$rolPerfil   = ($usuarioP['rol'] === 'admin' || $usuarioP['rol'] === 'superadmin') 
               ? 'Administrador' 
               : ucfirst($usuarioP['rol'] ?? 'Staff');
...
<header class="barra-superior d-flex align-items-center justify-content-between">
    ...
    <div class="acciones-barra d-flex align-items-center gap-3">
                    ...
                    <?php if ($cantidadNotif > 0): ?>
                        <?php foreach ($misNotificaciones as $notif): ?>
                            ...
                            <li class="notification-item d-flex align-items-start p-3 border-bottom">
                                ...
                                <div>
                                    <h6 class="mb-1 fw-bold fs-6 text-dark">
                                        <?= htmlspecialchars($notif['titulo']) ?>
                                    </h6>
                                    <p class="mb-1 small text-secondary lh-sm">
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center rounded-2 py-2 <?= $idiomaActual === 'es' ? 'active' : '' ?>" 
                       href="<?= BASE_URL ?>/idioma?lang=es">
                        <img src="<?= BASE_URL ?>/public/assets/dashboard/img/es.png" height="16" class="me-2"> 
                        Español
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center rounded-2 py-2 <?= $idiomaActual === 'en' ? 'active' : '' ?>" 
                       href="<?= BASE_URL ?>/idioma?lang=en">
                        <img src="<?= BASE_URL ?>/public/assets/dashboard/img/us.png" height="16" class="me-2"> 
                        English
                    </a>
                </li>
            </ul>
        ...
        <!-- PERFIL DE USUARIO -->
        <div class="nav-item dropdown">
            <a class="nav-link d-flex align-items-center gap-2 ps-2" 
               href="#" 
               data-bs-toggle="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow border-0 pt-0" style="min-width: 200px;">
                ...
                <!-- ✅ Corregido: configuracion → ajustes -->
                <li>
                    <a class="dropdown-item d-flex align-items-center py-2" 
                       href="<?= BASE_URL ?>/admin/ajustes">

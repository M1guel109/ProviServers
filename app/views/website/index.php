...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>/public/assets/website/css/landing.css">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
            <div class="container-fluid py-2 px-4">
                <a class="navbar-brand fw-bold text-primary" href="#">
                    <img src="<?= BASE_URL ?>/public/assets/img/logos/logo-principal.png" alt="Logo Proviservers" width="280" class="me-2"></a>
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="contenedor-superpuesto">
                        <img src="<?= BASE_URL ?>/public/assets/website/img/servicios-2.png" data-aos="fade-right" data-aos-duration="1000" alt="Persona mayor sonriendo" class="img-servicio-base">
                        <img src="<?= BASE_URL ?>/public/assets/website/img/servicios.png" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="200" alt="Persona usando taladro" class="img-servicio-superpuesta">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="roles-cards">
                    <article class="role-card">
                        <img src="<?= BASE_URL ?>/public/assets/website/img/roles1.png" alt="Proveedor" class="role-img">
                    ...
                    <article class="role-card">
                        <img src="<?= BASE_URL ?>/public/assets/website/img/roles2.png" alt="Cliente" class="role-img">
                        <div class="role-content">
                            <h5>Cliente</h5>
                            <p>
        ...
        <section id="pricing" class="pricing-section">
            <div class="pricing-background">
                <img src="<?= BASE_URL ?>/public/assets/website/img/background.png" alt="Background" class="background-image">
            </div>
                ...
                <div class="testimonials-header">
                    ...
                    <div class="testimonial-carousel">
                        ...
                        <div class="testimonial-card active">
                            <div class="testimonial-content">
                                <div class="testimonial-avatar">
                                    <img src="<?= BASE_URL ?>/public/assets/website/img/comentarios.png" alt="Cliente Carlos Marín" />
                                </div>
                        ...
                        <div class="testimonial-card">
                            <div class="testimonial-content">
                                <div class="testimonial-avatar">
                                    <img src="<?= BASE_URL ?>/public/assets/website/img/comentarios.png" alt="Cliente Laura Gómez" />
                                </div>
                                <div class="testimonial-info">
                                    <h3>Laura Gómez</h3>
                                    <p class="client-role">Cliente</p>
                        ...
                        <div class="testimonial-card">
                            <div class="testimonial-content">
                                <div class="testimonial-avatar">
                                    <img src="<?= BASE_URL ?>/public/assets/website/img/comentarios.png" alt="Proveedor Andrés Torres" />
                                </div>
                                <div class="testimonial-info">
                                    <h3>Andrés Torres</h3>
    ...
    <footer class="bg-dark text-white py-5">
        <div class="container">
            ...
            <div class="row mb-5 text-center">
                <div class="col">
                    <img src="<?= BASE_URL ?>/public/assets/img/logos/logo-positivo.png" alt="Logo Proviservers" width="200" />
                </div>
            </div>
    ...
    <script src="<?= BASE_URL ?>/public/assets/website/js/landing.js"></script>
</body>
